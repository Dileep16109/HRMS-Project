...
public interface EmployeeRepository extends JpaRepository<Employee, Integer> {
	    ...
	    List<Employee> findEmployeesJoinedLast10Years(@Param("date") LocalDate date);
	    
	    @Query("SELECT COUNT(e) FROM Employee e WHERE e.hireDate >= :date")
	    int countEmployeesJoinedLast10Years(@Param("date") LocalDate date);
		...
		List<Employee> findByEmailemployee(String email);
