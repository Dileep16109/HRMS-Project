...
public class DepartmentManagerController {
	...
	public DepartmentManager findByEmpNoDeptNoAndFromDate(@PathVariable("empNo") int empNo,
	 ...
	 @GetMapping("/from-date/{fromDate}")
	    public List<Object[]> getEmployeesFromDate(@PathVariable("fromDate") @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate fromDate) {
	...
	public ResponseEntity<Void> deleteDepartmentManagerByEmpNoAndDeptNoAndFromDate(@PathVariable int empNo,
			@PathVariable String deptNo, @PathVariable @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate fromDate) {
...
//	    DepartmentEmployee department=departmentEmployeeServices.getDepartEmployeeByEmpNo(empNo).getDepartment();
//	    if (employee == null) {
